...
describe("stopImpersonating action scenarios", () => {
  it("stops the real session before redirecting", async () => {
    ...
    await expect(stopImpersonating()).rejects.toThrow("NEXT_REDIRECT");
  });
});
